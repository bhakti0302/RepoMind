...
# This script removes large files from your branch but keeps them in your working directory

# Find large files in the current branch
echo "Finding large files in your branch..."
...
if [ -z "$large_files" ]; then
    echo "No large files found in your branch."
    exit 0
fi

# Ask for confirmation
read -p "Do you want to remove these large files from your branch? (y/n) " -n 1 -r
echo
if [[ $REPLY =~ ^[Yy]$ ]]; then
