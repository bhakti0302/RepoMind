...
This script tests the LLM client with OpenRouter using a simple prompt.
"""
...
def test_openrouter():
    """Test the LLM client with OpenRouter using a simple prompt."""
    ...
    output_file = "/Users/bhaktichindhe/Desktop/Project/RepoMind/codebase-analyser/output/openrouter_test_output.txt"
