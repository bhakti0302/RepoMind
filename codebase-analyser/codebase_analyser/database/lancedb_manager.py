            ...
            try:
                ...
                try:
                    ...
                    if "vector does not exist" in str(e):
                        ...
                        logger.info("Trying search with 'embedding' as vector column")
                ...
                # Older versions might use a different API or have different column names
                logger.warning(f"Using legacy search API: {e}")
                ...
                try:
                    ...
                    try:
                        ...
                        logger.error(f"All search attempts failed: {e2}")
