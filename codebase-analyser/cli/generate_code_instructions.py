#!/usr/bin/env python3
"""
Script to generate LLM instructions file with generated code.

Usage:
    python -m cli.generate_code_instructions --requirements "Create a Java class..." --context "Existing code..." --output llm_instructions.txt
"""
...
from codebase_analyser.agent.nodes.code_generation import generate_instructions_with_code
...
async def main_async():
    ...
    parser = argparse.ArgumentParser(description='Generate LLM instructions file with code')
    ...
    parser.add_argument('--output', type=str, default='llm-instructions.txt',
    ...
    # Generate the instructions file with code
    ...
    if "instructions_file" in result and result["instructions_file"]:
        ...
        with open(result["instructions_file"], "r") as f:
            ...
            logger.info(f"Preview of instructions file:\n{content[:preview_length]}...")
    else:
